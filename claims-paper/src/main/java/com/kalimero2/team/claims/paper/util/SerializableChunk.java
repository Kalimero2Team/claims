...
public record SerializableChunk(UUID world, int x, int z) implements ConfigurationSerializable, Serializable {

    public static SerializableChunk fromBukkitChunk(org.bukkit.Chunk chunk) {
